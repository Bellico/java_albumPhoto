...
public class PhotosBean {
    ...
    public PhotosBean(int idPhoto, String title, String descr, int width, int height, String img, String keyword, Date date_created, Time time_created, Date date_lastUpdate, Time time_lastUpdate, int idAlbum) {
