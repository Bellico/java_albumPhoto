...
public class UsersBean {
    ...
    public UsersBean(int idUser, String name, String firstName, String password, Date date_created, Time time_created, Date date_lastUpdate, Time time_lastUpdate) {
        this.idUser = idUser;
        this.name = name;
