...
public class Upload {
    ...
    public PhotoBean enregistrerFichier(HttpServletRequest request, String chemin) {
    ...
    private void ecrireFichier(InputStream contenu, String nomFichier, String chemin) throws Exception {
        ...
        try {
            /* Ouvre les flux. */
             System.out.print("ij ==>"+ chemin +"\\" +nomFichier);
