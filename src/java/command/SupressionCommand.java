...
public class SupressionCommand implements ICommand {
    ...
    public ActionFlow deleteUser(HttpServletRequest request, int num) {
        ArrayList<RightBean> rights = mapRight.getAllbyAttr("idUser", num);
        for (RightBean r : rights) {
            mapRight.delete(r);
        }
        ArrayList<AlbumBean> albums = mapAlbum.getAllbyAttr("idUser", num);
    ...
    private void deleteAlbum(AlbumBean album) {
    ...
    public void deletePhoto(PhotoBean photo) {
